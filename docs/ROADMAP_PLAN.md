...
- **문서 버전**: v0.16.0 (현재) ~ v1.0-VISION
- **작성일자**: 2026년 8월 9일
- **최종 정렬**: 2026년 8월 20일 (v0.16.0 기준)
...
### 3.5 v0.15 — 작성 보조와 데이터 신뢰성 (일부 완료)
...
- **주간 변화 요약 (남음)**: WorkItem 스냅샷을 주차 간 비교해 신규·진척 증가·완료·지연·재개·장기 정체로 분류합니다. AI 없이 결정적으로 계산합니다.
- **보고 품질 점검 (일부 선행, 나머지 남음)**: 규칙 중 `지난주 계획의 이번주 실적 미확인`은 위 작성 보조로 화면에서 이미 성립합니다. 동일 차주 계획 반복, 진척도 역행, 동일 이슈 장기화는 남습니다.
