...
- **문서 버전**: v0.14.1 (현재) ~ v1.0-VISION
- **작성일자**: 2026년 8월 9일
- **최종 정렬**: 2026년 8월 18일 (v0.14.1 기준)
...
- **경영 요약**: 관측 사실의 가중 합으로 최대 10건을 선정하고 선정 근거를 항상 함께 제시합니다(4.2 원칙).
