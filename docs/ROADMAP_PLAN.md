...
- **문서 버전**: v0.13.0 (현재) ~ v1.0-VISION
- **작성일자**: 2026년 8월 9일
- **최종 정렬**: 2026년 8월 18일 (v0.13.0 기준)
...
### 3.5 v0.15 — Decision Log와 회의 결과 반영
...
### 3.6 v0.16 — Dependency / Blocker Graph
