...
func (a *App) me(w http.ResponseWriter, r *http.Request) {
	...
	writeData(w, http.StatusOK, map[string]any{"user": p, "workflowEnabled": workflow, "aiEnabled": a.settingBool(r.Context(), "ai.enabled", false), "confluenceEnabled": a.settingBool(r.Context(), "confluence.enabled", false), "itsmEnabled": a.settingBool(r.Context(), "itsm.enabled", false), "itsmLabel": itsmLabelOrDefault(a.setting(r.Context(), "itsm.label", "")), "currentWeekStart": week.Format("2006-01-02"), "serviceName": a.setting(r.Context(), "service.name", "Weekly"), "notice": a.setting(r.Context(), "service.notice", ""), "accountNotice": accountNotice(p, workflow), "build": a.build})
}
