...
func (a *App) routes() {
	...
	a.mux.Handle("GET /api/v1/me/participation", a.requireAuth(http.HandlerFunc(a.myParticipation)))
	...
	a.mux.Handle("GET /api/v1/work-items/lookup", a.requireAuth(http.HandlerFunc(a.lookupWorkItems)))
