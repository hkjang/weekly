...
```bash
sha256sum weekly-v0.249.0.tar.gz
gzip -dc weekly-v0.249.0.tar.gz | tar -xO manifest.json | grep -o 'blobs/sha256/[0-9a-f]\{64\}' | head -1
gzip -dc weekly-v0.249.0.tar.gz | docker load
