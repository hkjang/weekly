...
제공된 `1월5주간업무보고_AI엔지니어링.pptx`를 기본 템플릿으로 내장합니다. 네 장의 원본 슬라이드 크기, 마스터, 표, 도형, 글꼴과 이미지는 그대로 유지하고 조직명, 추진실적·추진계획 일정과 이번 주/다음 주 업무만 자동으로 교체합니다. 업무 항목은 `category`별로 원본 슬라이드에 배치됩니다.
