...
export interface Providers { local: boolean; oidc: boolean; autoLogin: boolean; mcpOAuth?: boolean; name: string; notice: string; build: BuildInfo }
...
export interface WorkItem {
  ...
  firstWeek: string; lastWeek: string; reportedWeeks: number; ageWeeks: number; silentWeeks: number; staleWeeks: number
